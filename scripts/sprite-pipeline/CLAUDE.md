...
| `pipeline/extract_2d.py` | later wave | UnityPy → diffuse PNG |
...
| `tests/test_extract_2d.py` | later wave | Sample bundle → PNG hash |
| `tests/test_render_3d.py` | later wave | Sample GLB → PNG (`@pytest.mark.slow`) |
| `tests/test_output_dimensions.py` | later wave | RGBA + grid-size dimension checks |
